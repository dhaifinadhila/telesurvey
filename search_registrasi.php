  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Upload File Bukti Verifikasi </strong></div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
      <tr>
        <th height="19" scope="col">&nbsp;</th>
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><form action="call_view_tes.php" method="post" enctype="multipart/form-data" name="form_callback_sheet">
          <table width="80%" border="0" align="left" cellpadding="4" class="BorderBox_ColorStandard">
            ...
            <tr>
              <td class="_css_font_default_12"><div align="right"><strong>Nomor Registrasi</strong></div></td>
              <td class="_css_font_default_12"><strong>:</strong></td>
              <td><input name="var_nomor_registrasi" type="text" class="_css_input_text" ></td>
              <td>&nbsp;</td>
            </tr>
            ...
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td><input name="Submit" type="submit" class="button_default_aw" value="Search"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>

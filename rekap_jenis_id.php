  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Rekapitulasi </strong>&#8226; Rekapitulasi Identitas yang Digunakan</div> </th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
	  <tr>
        <th height="19" scope="col">&nbsp;</th>
		...
		<table id="example" class="display" cellspacing="0" width="100%">
				<thead class="_css_font_default_11_b">
					<tr>
						...
						<th><div align='center'>SIM</div></th>
						<th><div align='center'>PASPOR/Lainnya</div></th>
				...
				<tbody class="_css_font_default_11_b">
					...
					for ($i=0;$i<count($master);$i++) {
						...
						$VAR_KTP		=$master[$i]['KTP'];
						$VAR_SIM		=$master[$i]['SIM'];
						$VAR_LAINNYA		=$master[$i]['LAINNYA'];
						$VAR_TDK_BERSEDIA	=$master[$i]['TIDAK_BERSEDIA'];

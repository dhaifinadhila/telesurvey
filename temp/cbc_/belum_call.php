  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Belum Callback </strong>&#8226; <?php if ($_GET['pbpd']=="1"){ echo "Pelanggan Pasang Baru"; } else { echo "Pelanggan Perubahan Daya";} ?></div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
      <tr>
        <th height="19" scope="col">&nbsp;</th>
      ...
      <tr>
		...
		<table id="example" class="display" cellspacing="0" width="100%">
				...
				<tbody class="_css_font_default_11_b">
					...
					$master_call = belum_callback($var_JENIS_MUTASI); 
					$nomor=1;
					for ($i=0;$i<count($master_call);$i++) {
						...
						echo "<tr>";
							...
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_NOAGENDA)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_NO_REGISTRASI)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_TGLMOHON)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_IDPEL)."</div></td>";
							echo "<td><div align='left'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_NAMA)."</div></td>";
							echo "<td><div align='left'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_ALAMAT)."</div></td>";
							echo "<td><div align='left'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_NOTELP_PEMOHON)."</div></td>";
							echo "<td><div align='left'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_NOTELP_HP_PEMOHON)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_ASALMOHON)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_UPIENTRI)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_PETUGASCATAT)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_TARIF_LAMA)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_DAYA_LAMA)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_TARIF)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_DAYA)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_JENIS_TRANSAKSI)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_PAKET_SAR)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_TOTALBIAYA)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_TGLBAYAR)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_LAMAMOHON)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_STATUS_PERMOHONAN)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_TGL_UPDATE_PERMOHONAN)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_TGLPK)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_TGLNYALA)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_NAMAUPI)."</div></td>";
							echo "<td><div align='left'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_NAMAAP)."</div></td>";
							echo "<td><div align='left'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_NAMAUP)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_UNITTUJUAN)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_CBC_JENIS_MUTASI)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_CBC_STATUS_CALL)."</div></td>";
							echo "<td><div align='center'><a href='call.php?id=$VAR_ID_MASTER_CALL&token=$token'>".strtoupper($VAR_CBC_TANGGAL_UPLOAD)."</div></td>";

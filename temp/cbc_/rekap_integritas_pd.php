  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Rekapitulasi  </strong>&#8226; <strong> Rekapitulasi Integritas </strong>&#8226; Integritas Perubahan Daya </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
      <tr>
        <th height="19" scope="col">&nbsp;</th>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left">
            <table width="200" border="0" cellspacing="1">
              <tr>
                ...
                <td width="173"><a href="#" class="style1" onClick="return ExcellentExport.excel(this, 'example', 'rekap_integritas_pd');" download="rekap_integritas_pd.xls">Export to Excel</a></td>
              </tr>
            </table>
        </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      ...
      <tr>
		...
		<table id="example" class="display" cellspacing="0" width="100%">
				...
				<tbody class="_css_font_default_11_b">
					...
					$integritas_pd = rekap_integritas_pd();
					$nomor=1;
					for ($i=0;$i<count($integritas_pd);$i++) {
						$VAR_KODE_UNIT=$integritas_pd[$i]['KODE_UNIT'];


						$unit =  cbc_UNIT_search_BY_KODE_UNIT($VAR_KODE_UNIT);
						$VAR_NAMA_UNIT=$unit[0]['NAMA_UNIT'];						
						
						$VAR_TOTAL_PELANGGAN=$integritas_pd[$i]['TOTAL_PELANGGAN'];						
						$VAR_TAMBAHAN_BIAYA_YES=$integritas_pd[$i]['TAMBAHAN_BIAYA_YES'];												
						$VAR_TAMBAHAN_BIAYA_NO=$integritas_pd[$i]['TAMBAHAN_BIAYA_NO'];				

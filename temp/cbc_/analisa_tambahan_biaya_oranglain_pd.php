  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Analisa Callback   </strong>&#8226; <strong> Tambahan Biaya </strong>&#8226; Tambahan Biaya Perubahan Daya Diurus Orang Lain </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left">
            <table width="200" border="0" cellspacing="1">
              <tr>
                ...
                <td width="173"><a href="#" class="style1" onClick="return ExcellentExport.excel(this, 'example', 'analisa_tambahan_biaya_oranglain_pd');" download="analisa_tambahan_biaya_oranglain_pd.xls">Export to Excel</a></td>
              </tr>
            </table>
        </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      ...
      <tr>
		...
		<table id="example" class="display" cellspacing="0" width="100%">
				...
				<tbody class="_css_font_default_11_b">
					...
					$integritas_pb = biaya_oranglain_pd();
					$nomor=1;
					for ($i=0;$i<count($integritas_pb);$i++) {
						...
						$VAR_DIURUS_SENDIRI=$integritas_pb[$i]['DIURUS_ORANGLAIN'];												

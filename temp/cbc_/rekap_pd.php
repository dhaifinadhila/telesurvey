  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Rekapitulasi  </strong>&#8226; <strong> Rekapitulasi Resume </strong>&#8226; Resume Perubahan Daya </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left">
            <table width="200" border="0" cellspacing="1">
              <tr>
                ...
                <td width="173"><a href="#" class="style1" onClick="return ExcellentExport.excel(this, 'example', 'rekap_pd');" download="rekap_pd.xls">Export to Excel</a></td>
              </tr>
            </table>
        </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
		...
		<table id="example" class="display" cellspacing="0" width="100%">
				<thead class="_css_font_default_11_b">
					<tr>
						...
						<th><div align='center'>PELANGGAN MENGURUS SENDIRI </div></th>
						<th><div align='center'>SELESAI KURANG 4 HARI </div></th> 
					</tr>
				</thead>
				...
				<tbody class="_css_font_default_11_b">
					...
					for ($i=0;$i<count($integritas_pb);$i++) {
						...
						$VAR_PELANGGAN_BIAYA_TAMBAHAN=$integritas_pb[$i]['PELANGGAN_BIAYA_TAMBAHAN'];												
						$VAR_PELANGGAN_MENGURUS_SENDIRI=$integritas_pb[$i]['PELANGGAN_MENGURUS_SENDIRI'];												
						$VAR_DURASI_KURANG_4HARI=$integritas_pb[$i]['DURASI_KURANG_4HARI'];				
						
						$total_PELANGGAN_BIAYA_TAMBAHAN = $total_PELANGGAN_BIAYA_TAMBAHAN + $VAR_PELANGGAN_BIAYA_TAMBAHAN;
						$total_PELANGGAN_MENGURUS_SENDIRI = $total_PELANGGAN_MENGURUS_SENDIRI + $VAR_PELANGGAN_MENGURUS_SENDIRI;
						$total_DURASI_KURANG_4HARI = $total_DURASI_KURANG_4HARI + $VAR_DURASI_KURANG_4HARI;																				 
						...
						echo "<tr>";
							...
							echo "<td><div align='center'>".strtoupper($VAR_PELANGGAN_BIAYA_TAMBAHAN)."</div></td>";
							echo "<td><div align='center'>".strtoupper($VAR_PELANGGAN_MENGURUS_SENDIRI)."</div></td>";
							echo "<td><div align='center'>".strtoupper($VAR_DURASI_KURANG_4HARI)."</div></td>";
					...
					<tr>
						...
						<th><div align='center'><? echo $total_PELANGGAN_BIAYA_TAMBAHAN; ?></div></th>
						<th><div align='center'><? echo $total_PELANGGAN_MENGURUS_SENDIRI; ?></div></th>
						<th><div align='center'><? echo $total_DURASI_KURANG_4HARI; ?></div></th>						

      ...
      <tr>
		...
		<table id="example" class="display" cellspacing="0" width="100%">
				...
				<tbody class="_css_font_default_11_b">
					...
					<?
					$file_excell = cbc_file_excell_view_all();
					$nomor=1;
					for ($i=0;$i<count($file_excell);$i++) {
					
					   $VAR_ID_FILE_EXCELL = $file_excell[$i]['ID_FILE_EXCELL'];
					   $VAR_ID_PENGGGUNA = $file_excell[$i]['ID_PENGGGUNA'];
					   // [KODE_DISTRIBUSI] => 0
					   // [KODE_UNIT] => 0
					   // [KODE_RAYON] => 0
					   $VAR_NAMA_FILE_ASLI = $file_excell[$i]['NAMA_FILE_ASLI'];
					   $VAR_NAMA_FILE_RENAME = $file_excell[$i]['NAMA_FILE_RENAME'];
					   $VAR_UKURAN = $file_excell[$i]['UKURAN'];
					   $VAR_TANGGAL_UPLOAD = $file_excell[$i]['TANGGAL_UPLOAD'];
                    
 
					
						echo "<tr>";
							echo "<td>".$nomor."</td>";	
							echo "<td>".$VAR_ID_PENGGGUNA."</td>";
							echo "<td><div align='left'>".strtoupper($VAR_NAMA_FILE_RENAME)."</div></td>";
							echo "<td><div align='right'>".strtoupper($VAR_UKURAN)." KB</div></td>";
							
							echo "<td><div align='center'>".strtoupper($VAR_TANGGAL_UPLOAD)."</div></td>";
							echo "<td><div align='center'><a href='upload_excell/".$VAR_NAMA_FILE_RENAME."'>DOWNLOAD</div></td>";					

...
$hak_akses = cbc_hak_akses_search_by_id_hak_akses($VAR_ID_HAK_AKSES);

$VAR_ID_HAK_AKSES = $hak_akses[0]['ID_HAK_AKSES'];
$VAR_KODE_HAK_AKSES = $hak_akses[0]['KODE_HAK_AKSES'];
$VAR_KETERANGAN = $hak_akses[0]['KETERANGAN'];
  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Data Master </strong>&#8226; Hak Akses Aplikasi </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
      <tr>
        <th height="19" scope="col">&nbsp;</th>
      ...
      <tr>
		...
		<form action="hak_akses_edit_submit.php?id=<? echo $VAR_ID_HAK_AKSES; ?>" method="post" enctype="multipart/form-data" name="form_callback_sheet">
          <table width="80%" border="0" align="left" class="BorderBox_ColorStandard">
            ...
            <tr>
              ...
              <td><input name="KODE_HAK_AKSES" type="text" class="_css_input_text" id="KODE_HAK_AKSES" value="<? echo $VAR_KODE_HAK_AKSES; ?>"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              ...
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><input name="KETERANGAN" type="text" class="_css_input_text" id="KETERANGAN" value="<? echo $VAR_KETERANGAN; ?>" size="60"></td>
              <td>&nbsp;</td>
            </tr>

        ...
        <th class="_css_font_default_11" scope="col"><div align="left">
            <table width="200" border="0" cellspacing="1">
              <tr>
                ...
                <td width="173"><a href="#" class="style1" onClick="return ExcellentExport.excel(this, 'example', 'Petugas');" download="petugas.xls">Export to Excel</a></td>
              </tr>
            </table>
        </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
		...
		<table id="example" class="display" cellspacing="0" width="100%">
				<thead class="_css_font_default_11_b">
					<tr>
						...
						<th><div align='center'>KONTRIBUSI PETUGAS TERHADAP TARGET</div></th>
				...
				<tbody class="_css_font_default_11_b">
					...
					for ($i=0;$i<count($kinerja);$i++) {
						...
						$persen = ($VAR_TOTAL_PELANGGAN/$VAR_TARGET_CALL)*100;

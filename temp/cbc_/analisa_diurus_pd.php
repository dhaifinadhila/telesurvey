  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Analisa Callback   </strong>&#8226; <strong> Diurus Sendiri dan Diurus Pihak Lain </strong>&#8226; Diurus Sendiri dan Diurus Pihak Lain Perubahan Daya </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left">
            <table width="200" border="0" cellspacing="1">
              <tr>
                ...
                <td width="173"><a href="#" class="style1" onClick="return ExcellentExport.excel(this, 'example', 'analisa_diurus_pd');" download="analisa_diurus_pd.xls">Export to Excel</a></td>
              </tr>
            </table>
        </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
		...
		<table id="example" class="display" cellspacing="0" width="100%">
				<thead class="_css_font_default_11_b">
					<tr>
						...
						<th><div align='center'>DIURUS PELANGGAN SENDIRI </div></th>						
						<th><div align='center'>DIURUS OLEH ORANG LAIN  </div></th>
				...
				<tbody class="_css_font_default_11_b">
					...
					$integritas_pb = analisa_diurus_pd();
					$nomor=1;
					for ($i=0;$i<count($integritas_pb);$i++) {
						...
						$VAR_DIURUS_ORANGLAIN=$integritas_pb[$i]['DIURUS_ORANGLAIN'];												
						$VAR_DIURUS_SENDIRI=$integritas_pb[$i]['DIURUS_SENDIRI'];												
		
						
 						$total_DIURUS_ORANGLAIN = $total_DIURUS_ORANGLAIN + $VAR_DIURUS_ORANGLAIN;
						...
						echo "<tr>";
							...
							echo "<td><div align='center'>".strtoupper($VAR_DIURUS_ORANGLAIN)."</div></td>";
					...
					<tr>
						...
						<th><div align='center'><? echo $total_DIURUS_ORANGLAIN; ?></div></th>
					</tr>
				</tbody>
			</table>		</th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>

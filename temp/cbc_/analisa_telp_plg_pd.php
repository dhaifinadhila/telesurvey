  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Analisa Callback   </strong>&#8226; <strong> Nomor Telepon Pelanggan dan Pihak Lain </strong>&#8226; Telepon Pelanggan dan Pihak Lain Perubahan Daya </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left">
            <table width="200" border="0" cellspacing="1">
              <tr>
                ...
                <td width="173"><a href="#" class="style1" onClick="return ExcellentExport.excel(this, 'example', 'analisa_telp_plg_pd');" download="analisa_telp_plg_pd.xls">Export to Excel</a></td>
              </tr>
            </table>
        </div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
		...
		<table id="example" class="display" cellspacing="0" width="100%">
				<thead class="_css_font_default_11_b">
					<tr>
						...
						<th><div align='center'>NOMOR TELEPON PELANGGAN </div></th>
						<th><div align='center'>NOMOR TELEPON ORANG LAIN </div></th>
					</tr>
				</thead>
				...
				<tbody class="_css_font_default_11_b">
					...
					$integritas_pb = mv_analisa_telp_plg_pd();
					$nomor=1;
					for ($i=0;$i<count($integritas_pb);$i++) {
						...
						$VAR_TELP_PELANGGAN_YES=$integritas_pb[$i]['TELP_PELANGGAN_YES'];												
						$VAR_TELP_PELANGGAN_NO=$integritas_pb[$i]['TELP_PELANGGAN_NO'];												
		
						
 						$total_TELP_PELANGGAN_YES = $total_TELP_PELANGGAN_YES + $VAR_TELP_PELANGGAN_YES;
						$total_TELP_PELANGGAN_NO = $total_TELP_PELANGGAN_NO + $VAR_TELP_PELANGGAN_NO;																				 
						...
						echo "<tr>";
							...
							echo "<td><div align='center'>".strtoupper($VAR_TELP_PELANGGAN_YES)."</div></td>";
							echo "<td><div align='center'>".strtoupper($VAR_TELP_PELANGGAN_NO)."</div></td>";

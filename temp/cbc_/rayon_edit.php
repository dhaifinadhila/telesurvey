...
$rayon = cbc_rayon_search_by_id_rayon($VAR_ID_RAYON);
echo "<pre>";
print_r($rayon);
echo "</pre>";
		...
		<form action="rayon_edit_submit.php?id=<? echo $GET_ID_RAYON; ?>" method="post" enctype="multipart/form-data" name="form_callback_sheet">
          <table width="80%" border="0" align="left" class="BorderBox_ColorStandard">
            ...
            <tr>
			  ...
			  <select name="VAR_KODE_UNIT" class="_css_input_text">
					...
					for ($i=0;$i<count($unit);$i++) {
						...
						if ($VAR_KODE_UNIT==$GET_KODE_UNIT) {
            ...
            <tr>
              ...
              <td><textarea name="VAR_ALAMAT" cols="61" rows="3" class="_css_input_text" id="VAR_ALAMAT"><? echo $GET_ALAMAT; ?></textarea></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>

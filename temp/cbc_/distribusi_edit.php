...
$distribusi = cbc_DISTRIBUSI_search_by_ID_Distribusi($VAR_ID_DISTRIBUSI);
  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
		...
		<form action="distribusi_edit_submit.php?id=<? echo $VAR_ID_DISTRIBUSI; ?>" method="post" enctype="multipart/form-data" name="form_callback_sheet">
          <table width="80%" border="0" align="left" class="BorderBox_ColorStandard">
            ...
            <tr>
              ...
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><input name="NAMA_DISTRIBUSI" type="text" class="_css_input_text" id="NAMA_DISTRIBUSI" value="<? echo $VAR_NAMA_DISTRIBUSI; ?>" size="60"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              ...
              <td><textarea name="ALAMAT" cols="61" rows="3" class="_css_input_text" id="ALAMAT"><? echo $VAR_ALAMAT; ?></textarea></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>

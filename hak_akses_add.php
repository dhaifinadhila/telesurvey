				...
				<tr>
     			...
     			<tr>
      			...
      			<tr>
			        ...
			        <th class="_css_font_default_11" scope="col"><div align="left">  <strong>Hak Akses </strong>&#8226; Add Hak Akses</div></th>
			        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      			</tr>
      			<tr>
			        <th height="19" scope="col">&nbsp;</th>
      			...
      			<tr>
			        ...
			        <th class="_css_font_default_11" scope="col"><div align="left">
			            <div align="left">
			            	...
			            	<a href="hak_akses_add.php" class="button_default_aw">Add New Hak Akses</a>
			        	</div>
			        </th>
			        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      			</tr>
      			...
      			<tr>
			        ...
			        <th class="_css_font_default_11" scope="col">
			    		<form action="hak_akses_add_submit.php" method="post">
			          		<table width="80%" border="0" align="left" class="BorderBox_ColorStandard">
			            		...
			            		<tr>
			              			...
			              			<td class="_css_font_default_12">
			              				<div align="left"><strong>Kode Hak Akses</strong></div>
			              			</td>
			              			<td class="_css_font_default_12">
			              				<div align="center"><strong>:</strong></div>
			              			</td>
			              			<td>
			              				<input name="KODE_HAK_AKSES" type="text" class="_css_input_text">
			              			</td>
			              			<td>&nbsp;</td>
			            		</tr>
			            		...
			            		<tr>
			              			...
			              			<td><textarea name="KETERANGAN" cols="61" rows="3" class="_css_input_text"></textarea></td>
			              			<td>&nbsp;</td>
			            		</tr>
			            		<tr>
					              	<td>&nbsp;</td>

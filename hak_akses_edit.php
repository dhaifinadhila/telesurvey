...
$hak_akses = search_by_id_hak_akses($VAR_ID_HAK_AKSES);

$VAR_ID_HAK_AKSES 	= $hak_akses[0]['id_hak_akses'];
$VAR_KODE_HAK_AKSES = $hak_akses[0]['kode_hak_akses'];
$VAR_KETERANGAN 	 = $hak_akses[0]['nama_hak_akses'];
  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Data Master </strong>&#8226; Hak Akses Aplikasi &#8226; Edit Hak Akses Aplikasi</div></th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
      <tr>
        <th height="19" scope="col">&nbsp;</th>
      ...
      <tr>
		...
		<form action="hak_akses_edit_submit.php?id=<?php echo $VAR_ID_HAK_AKSES; ?>" method="post" enctype="multipart/form-data" name="form_callback_sheet">
          <table width="80%" border="0" align="left" class="BorderBox_ColorStandard">
            ...
            <tr>
              <td>&nbsp;</td>
              <td class="_css_font_default_12"><div align="left"><strong>Kode Hak Akses</strong> </div></td>
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><input name="KODE_HAK_AKSES" type="text" class="_css_input_text" id="KODE_HAK_AKSES" value="<?php echo $VAR_KODE_HAK_AKSES; ?>"></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              ...
              <td class="_css_font_default_12"><div align="center"><strong>:</strong></div></td>
              <td><input name="KETERANGAN" type="text" class="_css_input_text" id="KETERANGAN" value="<?php echo $VAR_KETERANGAN; ?>" size="60"></td>
              <td>&nbsp;</td>
            </tr>

...
$distribusi = search_by_id_distribusi($VAR_ID_DISTRIBUSI);

$id_distribusi      =$distribusi[0]['id_distribusi'];
$VAR_KODE_DISTRIBUSI=$distribusi[0]['kode_distribusi'];
$VAR_NAMA_DISTRIBUSI=$distribusi[0]['nama_distribusi'];
$VAR_KETERANGAN   	=$distribusi[0]['keterangan'];
?>
				...
				<tr>
     			...
     			<tr>
      			...
      			<tr>
			        ...
			        <th class="_css_font_default_11" scope="col">
			    		<form action="distribusi_edit_submit.php?id_distribusi=<?php echo $id_distribusi; ?>" method="post" enctype="multipart/form-data" name="form_callback_sheet">
			          		<table width="80%" border="0" align="left" class="BorderBox_ColorStandard">
					            ...
					            <input type="hidden" name="id" value="<?php echo $id_distribusi;?>">
			            		<tr>
			              			<td>&nbsp;</td>
			              			...
			              			<td>
			              				<input name="kode_distribusi" type="text" class="_css_input_text" value="<?php echo $VAR_KODE_DISTRIBUSI; ?>">
			              			</td>
			              			<td>&nbsp;</td>
			            		</tr>
			            		<tr>
			              			...
			              			<td>
			              				<input name="nama_distribusi" type="text" class="_css_input_text" value="<?php echo $VAR_NAMA_DISTRIBUSI; ?>">
			              			</td>
			              			<td>&nbsp;</td>
			            		</tr>
			            		<tr>
			              			...
			              			<td><textarea name="ket_distribusi" cols="61" rows="3" class="_css_input_text"><?php echo $VAR_KETERANGAN; ?></textarea></td>
			              			<td>&nbsp;</td>
			            		</tr>
			            		<tr>
					              	<td>&nbsp;</td>

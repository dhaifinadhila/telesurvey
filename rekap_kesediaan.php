  ...
  <tr>
    <td width="1028" height="173" colspan="3" align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      ...
      <tr>
        ...
        <th class="_css_font_default_11" scope="col"><div align="left"><strong>Rekapitulasi </strong>&#8226; Rekapitulasi Kesediaan</div> </th>
        <th class="_css_font_default_11" scope="col">&nbsp;</th>
      </tr>
	  <tr>
        <th height="19" scope="col">&nbsp;</th>
		...
		<table id="example" class="display" cellspacing="0" width="100%">
				<thead class="_css_font_default_11_b">
					<tr>
						...
						<th><div align='center'>Bersedia</div></th>						
						<th><div align='center'>Tidak Bersedia & Minta Waktu</div></th>
						<th><div align='center'>Tidak Bersedia & Minta Cek</div></th>
				...
				<tbody class="_css_font_default_11_b">
					...
					for ($i=0;$i<count($master);$i++) {
						...
						$VAR_KTP		=$master[$i]['BERSEDIA_PD'];
						$VAR_SIM		=$master[$i]['TDK_BERSEDIA_PD_MINTA_WAKTU'];
						$VAR_LAINNYA		=$master[$i]['TDK_BERSEDIA_MINTA_CEK'];
						$VAR_TDK_BERSEDIA	=$master[$i]['TDK_BERSEDIA_PD'];
					...
					$pengguna = tm_pengguna_search_by_id_pengguna($VAR_ID_PENGGUNA);
						...
						echo "<tr>";
							...
							echo "<td><div align='center'>".strtoupper($VAR_KTP)."</div></td>";
							echo "<td><div align='center'>".strtoupper($VAR_SIM)."</div></td>";
							echo "<td><div align='center'>".strtoupper($VAR_LAINNYA)."</div></td>";

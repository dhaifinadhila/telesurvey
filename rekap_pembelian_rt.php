    		...
    		<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
			    ...
			    <tr>
		      	...
		      	<tr>
		        	...
		        	<th class="_css_font_default_11" scope="col"><div align="left"><strong>Pembelian Peralatan Rumah Tangga</strong>&#8226; <?php// if ($_GET['pbpd']=="1"){ echo "Pelanggan Pasang Baru"; } else { echo "Pelanggan Perubahan Daya";} ?></div></th>
		        	<th class="_css_font_default_11" scope="col">&nbsp;</th>
		      	</tr>
      			<tr>
			        <th height="19" scope="col">&nbsp;</th>
			        <th class="_css_font_default_11" scope="col"><div align="left">
            			<table width="200" border="0" cellspacing="1">
			              	<tr>
				                ...
				                <td width="173"><a href="export/export_rekap_pembelian_rt.php"  >Export to Excel</a></td>
			              	</tr>
            			</table>
        			</div></th>
        			<th class="_css_font_default_11" scope="col">&nbsp;</th>

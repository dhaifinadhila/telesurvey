        ...
        <th class="_css_font_default_11" scope="col"><form action="rayon_add_submit.php" method="post" enctype="multipart/form-data" name="form_callback_sheet">
          <table width="80%" border="0" align="left" class="BorderBox_ColorStandard">
            ...
            <tr>
              ...
              <td><textarea name="VAR_KETERANGAN" cols="61" rows="3" class="_css_input_text" id="VAR_KETERANGAN"></textarea></td>
              <td>&nbsp;</td>
            </tr>
            <tr>
              <td>&nbsp;</td>

...
for ($i=3;$i<count($sheet_1)-1;$i++)
{
	...
	$nilai_delta_2 =  $sheet_1[$i][2];
	$nilai_delta_2_blth = '201402';  

	$nilai_delta_3 =  $sheet_1[$i][3];
	$nilai_delta_3_blth = '201403';  

	$nilai_delta_4 =  $sheet_1[$i][4];
	$nilai_delta_4_blth = '201404';  

	$nilai_delta_5 =  $sheet_1[$i][5];
	$nilai_delta_5_blth = '201405';  

	$nilai_delta_6 =  $sheet_1[$i][6];
	$nilai_delta_6_blth = '201406';  

	$nilai_delta_7 =  $sheet_1[$i][7];
	...
	$get_var_informasi = '0';
	$return_insert_pelanggan_jumlah = insert_pelanggan_jumlah($get_var_kode_area,$get_var_nama_area,$get_var_bulan_tahun,$get_var_delta_pelanggan,$get_var_upload_by,$get_var_informasi);
